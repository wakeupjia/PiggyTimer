...
A minimal macOS menu bar study timer. 灵感来自"有效学习时间"这个概念。市面上计时器都太复杂了，我只需要一个东西：一眼看到今天学了多少。

灵感来自"有效学习时间"这个概念——坐在书桌前不算，真正专注学习的时间才算。当有效学习时间累积到 10h、50h、100h，你会看到成效。

市面上计时器都太复杂了，我只需要一个东西：一眼看到今天学了多少。
